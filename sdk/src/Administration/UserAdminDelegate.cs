...
//-------------------------------------------------------------------------
namespace Keycloak.Administration
{
    using System;
    ...
    /// </summary>
    public class UserAdminDelegate : IUserAdminDelegate
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAdminDelegate"/> class.
        /// </summary>
        /// <param name="logger">The injected logger provider.</param>
        /// <param name="httpClientService">injected HTTP client service.</param>
        /// <param name="configuration">Injected configuration.</param>
        public UserAdminDelegate(
            ILogger<UserAdminDelegate> logger,
